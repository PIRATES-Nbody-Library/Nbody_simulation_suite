...
c
c
c Remarks: Taken from step_kdk.  The only difference from original is that
c          the forces are always calculated between the planets.
c Authors:  Hal Levison
c Date:    9/18/05
c Last revision:

      subroutine rmvs4_step_norm(i1st,time,nbod,ntp,mass,j2rp2,j4rp4,
