...
c
      ...
      subroutine symba5_merge(t,dt,nbod,nbodm,ip1,ip2,mass,xh,yh,zh,vxb,
...
c...  Executable code
      ...
      if(rlim2.ge.rr2) then
         ip1l = ip1
         ip2l = ip2
         call discard_mass_merge5_mtiny(t,nbod,nbodm,ip1l,ip2l,mass,xh,
     &        yh,zh,vxb,vyb,vzb,rpl,eoff,ielc,ielst,NENMAX)
         mergecnt = mergecnt + 1
     ...
     &              mass,xh,yh,zh,vxb,vyb,vzb,rpl,eoff,ielc,ielst,
     &              NENMAX)
               mergecnt = mergecnt + 1
               mergelst(1,mergecnt) = ip1l
               mergelst(2,mergecnt) = ip2l
